...
VERSION=$1
API_RELEASES_LIST="https://api.github.com/repos/fan-ADN/nendSDK-iOS-MoPub-CustomEvent/releases"
UPLOAD_URL=''
...
curl -X POST -H "Authorization: token $TOKEN" \
    -H "Content-Type: application/zip" --data-binary @NendMoPubCustomEventSample/out_archive_without_sign.zip $UPLOAD_URL
